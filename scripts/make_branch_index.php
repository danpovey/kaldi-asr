...
//    e.g.: php make_index.php /mnt/kaldi-asr-data trunk egs/wsj 1 2 5 7
...
foreach ($input_dirs as $b => $input_dir) {
  ...
  $all_metadata["$b.date"] = date('d M Y', $all_metadata["$b.time"]);
  ...
  $all_metadata["$b.size_human_readable"] = human_readable_size(1024 * $file_contents[0]);
}
